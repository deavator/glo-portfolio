...
$name = $_POST['user_name']; // получаем имя клиента
$email = $_POST['user_email']; // получаем почту клиента
$message = $_POST['user_message']; // получаем сообщение клиента

// воодим между кавычек токен бота, который прислал @botfater
$token = "8167761069:AAGR3YmnZA-PFE66h8xw1WYde5xT_vH6jXw"; 
